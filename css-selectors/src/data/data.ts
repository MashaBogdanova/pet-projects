...
export const levelsData: Array<ILevelParams> = [
    ...
    },
    {
        ...
        itemsSet:
            '<div class="plate plate_fancy"></div>' +
            '<div class="plate"><div class="yummy yummy_top"></div></div>' +
            '<div class="yummy"></div>',
        levelHint: {
            title: 'No worries, you\'ve got this!',
            text: 'You\'re about to learn CSS Selectors! Selectors are how you pick which element to apply styles to.' +
    ...
    },
    {
        ...
        itemsSet:
            ...
            '<div class="yummy yummy_cupcake yummy_small"></div>' +
            '<div class="plate"><div class="yummy yummy_cupcake yummy_small yummy_top"></div></div>' +
            '<div class="plate"></div>',
        levelHint: {
            title: 'No worries, you\'ve got this!',
            text: 'You\'re about to learn CSS Selectors! Selectors are how you pick which element to apply styles to.' +
    ...
    },
    {
        ...
        itemsSet:
            '<div class="yummy yummy_strawberry"></div>' +
            '<div class="plate"><div class="yummy yummy_cupcake yummy_top yummy_small"></div></div>' +
            '<div class="plate plate_fancy"></div>' +
            '<div class="plate plate_fancy"><div class="yummy yummy_cupcake yummy_top"></div></div>' +
            '<div class="plate"></div>',
        levelHint: {
            title: 'No worries, you\'ve got this!',
            text: 'You\'re about to learn CSS Selectors! Selectors are how you pick which element to apply styles to.' +
    ...
    },
    {
        ...
        itemsSet:
            '<div class="plate"><div class="yummy yummy_cake yummy_top"></div></div>' +
